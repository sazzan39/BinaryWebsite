    ...
    <div className="min-h-screen bg-bg text-ink selection:bg-bezel selection:text-onnavy">
      ...
      <section id="results" className="bg-card border-y border-line">
        <div className="max-w-[1120px] mx-auto px-6 py-20 md:py-28">
          ...
          <p className="mt-10 font-mono text-[11px] tracking-[0.15em] uppercase text-faint2">
          ...
          <div className="mt-5 grid sm:grid-cols-2 gap-6">
            {PROOF.map((p) => (
              <div
                key={p.stat}
                className="rounded-2xl border border-line bg-bg p-8 md:p-10 flex flex-col"
              >
                <p className="font-mono text-[11px] tracking-wide uppercase text-faint2">
                  {p.source}
                </p>
